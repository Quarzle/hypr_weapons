...
execute at @s unless block ~ ~-0.1 ~ #h_weapons:raycast_impassable run tp @s ~ ~-0.1 ~
execute at @s if block ~ ~-0.1 ~ #h_weapons:raycast_impassable run scoreboard players set %solved variable 1

execute at @s if block ~ ~0.1 ~ #h_weapons:raycast_impassable run scoreboard players set %solved variable 0
execute at @s if block ~ ~0.1 ~ #h_weapons:raycast_impassable run tp @s ~ ~0.1 ~
