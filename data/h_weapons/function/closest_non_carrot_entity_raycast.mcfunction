...
execute as @e[limit=1,distance=..4,tag=!carrot_warrior,sort=nearest,type=!mannequin,type=!#minecraft:arrows,type=!item,type=!item_frame,type=!glow_item_frame] run particle minecraft:flame ~ ~2 ~ 0.2 0.2 0.2 0.05 12
