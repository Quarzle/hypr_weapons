...
#enchant
# execute as @s[tag=!was_right_clicking,tag=right_clicking] if items entity @s weapon.mainhand minecraft:carrot_on_a_stick[custom_model_data={strings:["enchant"]}] at @s run particle cloud ~ ~ ~ 0.3 0.3 0.3 0.2 40
execute as @s[tag=!was_right_clicking,tag=right_clicking] if items entity @s weapon.mainhand minecraft:carrot_on_a_stick[custom_model_data={strings:["enchant"]}] run scoreboard players set %blocks_traversed variable 0
