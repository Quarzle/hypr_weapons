...
execute if block ~ ~ ~ #h_weapons:raycast_impassable positioned ^ ^ ^-0.9 on vehicle run tp @s ~ ~ ~
execute if block ~ ~ ~ #h_weapons:raycast_impassable positioned ^ ^ ^-0.9 on vehicle run return 0
