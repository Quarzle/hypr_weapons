...
execute as @s[tag=!was_right_clicking,tag=right_clicking] at @s anchored eyes positioned ^ ^1 ^2 run summon text_display ~ ~ ~ {Tags:["temp_staff","spell_top"],text:"Warp 5 \uF806\uE020",background:0,CustomName:{"text":"warp"},interpolation_duration:1,see_through:true}
...
execute as @s[tag=right_clicking] at @s at @e[type=marker,tag=staff_pos_marker,limit=1,sort=nearest] anchored eyes positioned ^ ^1 ^2 run tp @e[limit=1,type=text_display,tag=temp_staff,tag=spell_top] ~ ~ ~
...
execute as @s[tag=was_right_clicking] at @s anchored eyes positioned ^ ^ ^2 run tag @e[type=text_display,tag=temp_staff,limit=1,sort=nearest,distance=..0.8] add selected
